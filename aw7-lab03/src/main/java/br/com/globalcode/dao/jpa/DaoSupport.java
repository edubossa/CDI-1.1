...
import br.com.globalcode.dao.PersistentEntity;
 ...
 * </ul>
 *
 * Seu uso simplifica a escrita das classes DAO, permitindo que se concentrem em
 * implementar somente os métodos relativos a consultas. Mesmo a escrita desses
 * métodos é facilitada pois a execução efetiva da consulta também é feita pela
 * classe DaoSupport.
 *
...
//    }
     ...
     * primária
     *
     * @param pk valor da chave primária
     * @return entidade
     */
     ...
     * nomeados
     *
     * @param query consulta em JPA QL
     * @param parameters Map com os parametros da consulta
     ...
     * parametros nomeados
     *
     * @param namedQuery nome da consulta
     * @param parameters Map com os parametros da consulta
     * @return resultado da consulta
     */
     ...
     *
     * @param query consulta em JPA QL
     * @param parameters varargs com os parametros da consulta
     * @return resultado da consulta
     */
    ...
    /**
     *
     * metodo que executa consultas com parametros indexados, retornando uma
     * única entidade
     *
     * @param q consulta a ser executada
     * @param parameters varargs com os parametros da consulta
    ...
    /**
     *
     * metodo que executa consultas com parametros nomeados, retornando uma
     * única entidade
     *
     * @param q consulta a ser executada
     * @param parameters Map com os parametros da consulta
