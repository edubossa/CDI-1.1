package br.com.globalcodeweb.util;
...
public class JSFHelper {
	...
	/**
	 * adiciona uma mensagem global de sucesso no contexto Faces 
	 * para ser exibida em uma página JSF através da tag <h:messages>
	 * 
	...
	/**
	 * adiciona uma mensagem global de erro no contexto Faces 
	 * para ser exibida em uma página JSF através da tag <h:messages>
	 * 
	 * @param message texto da mensagem a ser exibida
	 */
